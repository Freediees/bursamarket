...
function scene:create( event )
	...
	local teks1 = display.newText( "Panduan Haji & Umroh", 10 , 0 + menu1.y + menu1.height/2, used_font_bold, 15  * (display.contentWidth / 320)  )
	teks1.anchorX = 0
	teks1.anchorY = 0.5
	...
	local teks2 = display.newText( "Check List", 10 , 0 + menu2.y + menu2.height/2, used_font_bold, 15  * (display.contentWidth / 320)  )
	teks2.anchorX = 0
	teks2.anchorY = 0.5
	...
	local teks3 = display.newText( "Info Haji", 10 , 0 + menu3.y + menu3.height/2, used_font_bold, 15  * (display.contentWidth / 320)  )
	teks3.anchorX = 0
	teks3.anchorY = 0.5
	...
	local teks4 = display.newText( "Souvenir", 10 , 0 + menu4.y + menu4.height/2, used_font_bold, 15  * (display.contentWidth / 320)  )
	teks4.anchorX = 0
	teks4.anchorY = 0.5
