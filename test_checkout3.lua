...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
    ...
    local background_total = display.newRoundedRect( display.contentCenterX, label_yang_harus_dibayar.y + display.contentHeight/20, 0.9 * display.contentWidth, 50, 10)
...
Cabang : Bandung]],
    ...
    local background_konfirmasi = display.newRoundedRect( display.contentCenterX, label_teks8.y +label_teks8.height + display.contentHeight/20, 0.9 * display.contentWidth, 50, 10)
