...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
  ...
  composer.tinggi_teksfield = background2.height + display.contentHeight/30
	...
	local teks_sajadah = display.newText( "OLEH-OLEH HAJI", display.contentCenterX, display.contentHeight/20 , used_font_bold, 20  * (display.contentWidth / 320))
	teks_sajadah.anchorX = 0.5
	teks_sajadah:setFillColor(0.4)
	scrollView:insert(teks_sajadah)

	local teks_anak = display.newText( "BUSANA ANAK", display.contentCenterX, teks_sajadah.y + teks_sajadah.height + 10, used_font, 12  * (display.contentWidth / 320))
	teks_anak.anchorX = 0.5
	teks_anak:setFillColor(1)

	local back_anak = display.newRoundedRect(teks_anak.x, teks_anak.y, teks_anak.width + 10, teks_anak.height + 10, 5)
	back_anak.anchorX = 0.5
	back_anak:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_anak)
	scrollView:insert(teks_anak)

	local function onTeks_anak(event) 
        composer.status_kategori = 4
        but_teks_ukuran(teks_teks_anak)
      return true 
    end 
    teks_anak:addEventListener("tap", onTeks_anak ) 


	local teks_pria = display.newText( "BUSANA PRIA", back_anak.x - back_anak.width/2 - 10, back_anak.y, used_font, 12  * (display.contentWidth / 320))
	teks_pria.anchorX = 1
	teks_pria:setFillColor(1)

	local back_pria = display.newRoundedRect(teks_pria.x - teks_pria.width/2, teks_pria.y, teks_pria.width + 10, teks_pria.height + 10, 5)
	back_pria.anchorX = 0.5
	back_pria:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_pria)
	scrollView:insert(teks_pria)

	local function onTeks_pria(event) 
        composer.status_kategori = 5
        but_teks_ukuran(teks_teks_pria)
      return true 
    end 
    teks_pria:addEventListener("tap", onTeks_pria )


	local teks_wanita = display.newText( "BUSANA WANITA", back_anak.x + back_anak.width/2 + 10, back_anak.y, used_font, 12  * (display.contentWidth / 320))
	teks_wanita.anchorX = 0
	teks_wanita:setFillColor(1)

	local back_wanita = display.newRoundedRect(teks_wanita.x + teks_wanita.width/2, teks_wanita.y, teks_wanita.width + 10, teks_wanita.height + 10, 5)
	back_wanita.anchorX = 0.5
	back_wanita:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_wanita)
	scrollView:insert(teks_wanita)

	local function onTeks_wanita(event) 
        composer.status_kategori = 6
        but_teks_ukuran(teks_teks_wanita)
      return true 
    end 
    teks_wanita:addEventListener("tap", onTeks_wanita )

    local teks_sykava = display.newText( "SYKAVA", display.contentCenterX, back_pria.y + back_pria.height + 10, used_font, 12  * (display.contentWidth / 320))
	teks_sykava.anchorX = 0.5
	teks_sykava:setFillColor(1)

	local back_sykava = display.newRoundedRect(teks_sykava.x, teks_sykava.y, teks_sykava.width + 10, teks_sykava.height + 10, 5)
	back_sykava.anchorX = 0.5
	back_sykava:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_sykava)
	scrollView:insert(teks_sykava)

	local function onTeks_sykava(event) 
        composer.status_kategori = 7
        but_teks_ukuran(teks_sykava)
      return true 
    end 
    teks_sykava:addEventListener("tap", onTeks_sykava )

	local teks_zaleera = display.newText( "ZALEERA", back_sykava.x - back_sykava.width/2 - 10, back_sykava.y, used_font, 12  * (display.contentWidth / 320))
	teks_zaleera.anchorX = 1
	teks_zaleera:setFillColor(1)

	local back_zaleera = display.newRoundedRect(teks_zaleera.x - teks_zaleera.width/2, teks_zaleera.y, teks_zaleera.width + 10, teks_zaleera.height + 10, 5)
	back_zaleera.anchorX = 0.5
	back_zaleera:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_zaleera)
	scrollView:insert(teks_zaleera)


	local function onTeks_zaleera(event) 
        composer.status_kategori = 8
        but_teks_ukuran(teks_zaleera)
      return true 
    end 
    teks_zaleera:addEventListener("tap", onTeks_zaleera )


	local teks_syaheera = display.newText( "SYAHEERA", back_sykava.x + back_sykava.width/2 + 10, back_sykava.y, used_font, 12  * (display.contentWidth / 320))
	teks_syaheera.anchorX = 0
	teks_syaheera:setFillColor(1)

	local back_syaheera = display.newRoundedRect(teks_syaheera.x + teks_syaheera.width/2, teks_syaheera.y, teks_syaheera.width + 10, teks_syaheera.height + 10, 5)
	back_syaheera.anchorX = 0.5
	back_syaheera:setFillColor(133/255,190/255,72/255)
	
	scrollView:insert(back_syaheera)
	scrollView:insert(teks_syaheera)

	local function onTeks_syaheera(event) 
        composer.status_kategori = 9
        but_teks_ukuran(teks_syaheera)
      return true 
    end 
    teks_syaheera:addEventListener("tap", onTeks_syaheera )



   local teks_sorting = display.newText( "Sorting", 20,  teks_syaheera.y + display.contentWidth/10, used_font_bold, 12  * (display.contentWidth / 320))
...
function scene:show( event )
  ...
  if(composer.status_kategori == 1)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/39/-/terbaru/-/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)    		
	elseif(composer.status_kategori == 2)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/39/terendah/terbaru/-/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim ) 
	elseif(composer.status_kategori == 3)then
    		dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/39/-/-/terlaris/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim) 
	elseif(composer.status_kategori == 4)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/busana-anak/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	elseif(composer.status_kategori == 5)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/busana-pria/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	elseif(composer.status_kategori == 6)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/busana-wanita/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	elseif(composer.status_kategori == 7)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/sykava/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	elseif(composer.status_kategori == 8)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/zaleera/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	elseif(composer.status_kategori == 9)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/syaheera/10/"..composer.halaman_page, "GET", dataResponseListenerBusanaMuslim)
	end	
