...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
	...
	local function onCheckout()
		...
		composer.gotoScene("checkout2")

		end
	end

	local background_checkout = display.newRect( display.contentCenterX, garis8.y + display.contentHeight/10, display.contentWidth * 0.9, 50)
