...
function scene:create( event )
		  	...
		  	if(row.video18 == '0')then
				...
				local function networkListener( event )
				    ...
				    elseif ( event.phase == "progress" ) then
				        if ( event.bytesEstimated <= 0 ) then
				        	transfered.text = event.bytesTransferred.."/14228902"
				    ...
				    elseif ( event.phase == "ended" ) then
				        ...
				        transfered.text = event.bytesEstimated.."/14228902"


				         local tablesetup = [[UPDATE t_video set video18 = '1';]]
						 db:exec( tablesetup )
				        ...
				        video.anchorY = 0
				        video:load( "video18.mp4", system.DocumentsDirectory )
				        video:play()
				        ...
				        local function on_video()
				        	...
				        	media.playVideo( "video18.mp4", system.DocumentsDirectory, true )
				        end
				...
				download = network.download(
				    "http://bursasajadah.com/video/pelaksanaan_ibadah_haji-doa_thawaf7.mp4",
				    "GET",
				    networkListener,
				    params,
				    "video18.mp4",
	...
	local options = {
         text = "Doa Thawaf pada putaran ketujuh",
