...
function scene:show( event )
	...
	elseif phase == "did" then
     ...
     local function loadIconListenerPerlengkapanMuslim( event )
      ...
      local function tampil_next()
     
	end

	timer.performWithDelay(3000, tampil_next)
          ...
          local index
             ...
             for index = 1, data_max do
                  ...
                  local data = listData[index]
                    ...
                    local count = composer.gambar_iklan_perlengkapanmuslim
                    ...
                    local myImage = display.newImage( composer.imgDir.. "logo.png", 125, 39)
                      ...
                      local posisi_teks_x = myImage.x + (myImage.width * myImage.xScale /2)
                       ...
                       if(composer.gambar_iklan_perlengkapanmuslim%2 == 1)then
                      ...
                      local teks  = table.concat(composer.data_perlengkapanmuslim, ", ", composer.gambar_iklan_perlengkapanmuslim,composer.gambar_iklan_perlengkapanmuslim)
                      local teks2 = table.concat(composer.data_perlengkapanmuslim_harga, ", ", composer.gambar_iklan_perlengkapanmuslim,composer.gambar_iklan_perlengkapanmuslim)
					...
					myImage:addEventListener("tap", onProduk )
			         ...
			         scrollView:insert(teks_produk_diskon_harga);
                      ...
                      if(composer.gambar_iklan_perlengkapanmuslim == data_max) then
	...
	if(composer.halaman_menu5 == 1)then
		tampil_prev.alpha = 0
	...
	local function ontampil_next(event) 
	   ...
	   function but_tampil_next(self) 
	            ...
	            composer.gotoScene( "menu5" ) 
	            composer.halaman_menu5 = composer.halaman_menu5 + 10
	   ...
	   function but_tampil_prev(self) 
	            ...
	            composer.halaman_menu5 = composer.halaman_menu5 - 10
                    ...
                    cancelall[index] = network.download( download, "GET", networkListener,params, "perlengkapanmuslim"..index..".jpg", system.TemporaryDirectory, 0, 0 )
	...
	if(composer.status_kategori == 1)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/64/-/terbaru/-/10/"..composer.halaman_menu5, "GET", dataResponseListenerPerlengkapanMuslim)    		
	elseif(composer.status_kategori == 2)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/64/terendah/terbaru/-/10/"..composer.halaman_menu5, "GET", dataResponseListenerPerlengkapanMuslim ) 
	else
    		dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/64/-/-/terlaris/10/"..composer.halaman_menu5, "GET", dataResponseListenerPerlengkapanMuslim) 
	end
	end	
end
