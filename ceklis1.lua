...
function scene:create( event )
	...
	local teks_daftar_isi = display.newText( "Perlengkapan Haji Wanita", menu.x + display.contentWidth/8 , menu.y , used_font_bold, 20  * (display.contentWidth / 320)  )
 ...
 --    teks_umroh:addEventListener("tap", onteks_umroh) 
	...
	local function tambah_perlengkapan()
		...
		composer.showOverlay("overlay_popup1", options_overlay)
	end
