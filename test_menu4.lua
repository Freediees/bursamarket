...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
  ...
  composer.tinggi_teksfield = background2.height + display.contentHeight/30
	...
	local teks_sajadah = display.newText( "Perlengkapan Haji", display.contentCenterX, display.contentHeight/20 , used_font_bold, 15  * (display.contentWidth / 320))
	...
	local teks_tipe = display.newText( "PRIA", back_tipe.x - back_tipe.width/2, back_tipe.y , used_font_bold, 12  * (display.contentWidth / 320))
   ...
   function but_teks_tipe(self) 
	...
	local teks_ukuran = display.newText( "WANITA", back_ukuran.x + back_ukuran.width/2,  back_ukuran.y, used_font_bold, 12  * (display.contentWidth / 320))
