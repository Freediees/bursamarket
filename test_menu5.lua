...
function scene:create( event )
  ...
  composer.tinggi_teksfield = background2.height + display.contentHeight/30
	...
	local teks_sajadah = display.newText( "PERLENGKAPAN MUSLIM", display.contentCenterX, display.contentHeight/20 , used_font_bold, 15  * (display.contentWidth / 320))
    ...
    local teks_sorting = display.newText( "Sorting", 20,  teks_sajadah.y + display.contentWidth/10, used_font_bold, 12  * (display.contentWidth / 320))
