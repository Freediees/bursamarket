...
function scene:create( event )
		  	...
		  	if(row.video16 == '0')then
				...
				local function networkListener( event )
				    ...
				    elseif ( event.phase == "progress" ) then
				        if ( event.bytesEstimated <= 0 ) then
				        	transfered.text = event.bytesTransferred.."/20296494"
				    ...
				    elseif ( event.phase == "ended" ) then
				        ...
				        transfered.text = event.bytesEstimated.."/20296494"


				         local tablesetup = [[UPDATE t_video set video16 = '1';]]
						 db:exec( tablesetup )
				        ...
				        video.anchorY = 0
				        video:load( "video16.mp4", system.DocumentsDirectory )
				        video:play()
				        ...
				        local function on_video()
				        	...
				        	media.playVideo( "video16.mp4", system.DocumentsDirectory, true )
				        end
				...
				download = network.download(
				    "http://bursasajadah.com/video/pelaksanaan_ibadah_haji-doa_thawaf5.mp4",
				    "GET",
				    networkListener,
				    params,
				    "video16.mp4",
	...
	local options = {
         text = "Doa Thawaf pada putaran kelima",
     ...
     local options = {
		 text = [[Allahumma azhillanii tahta zhilli arsyika yauma laa zhilla illaa zhilluka, wa laa baqiya illaa wajhuka, wa asqinii min haudhi nabiyyika Muhammadin shallallahu 'alaihi wa sallama syurbatan haniiatan mariiatan laa azhmau ba'dahaa abadan. Allahumma innii as'aluka min khairi maa sa'alaka minhu nabiyyuka Muhammadun shallallahu 'alaihi wa sallama, wa a'uudzu bika min syarri ma sta'aadzaka minhu nabiyyuka Muhammadun shallahu 'alaihi wa sallama, Allahumma innii as'aluka l-jannata wa na'iimahaa wa maa yuqorribunii ilaihaa min qaulin aw fi'lin aw 'amalin, wa a'uudzu bika minan-naari wa maa yuqarribunii ilaihaa min qaulin au fi'lin au 'amalin.]],
         x = display.contentWidth*0.05,
