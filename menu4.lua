...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
	...
	local teks_pria = display.newText( "PERLENGKAPAN HAJI PRIA", display.contentCenterX, display.contentHeight/20 , used_font_bold, 12  * (display.contentWidth / 320))
   ...
   function but_teks_pria(self) 
	...
	local teks_wanita = display.newText( "PERLENGKAPAN HAJI WANITA", display.contentCenterX, teks_pria.y + display.contentHeight/20 , used_font_bold, 12  * (display.contentWidth / 320))
   ...
   function but_teks_wanita(self) 
	...
	local terbaru_box = display.newRect( display.contentCenterX, teks_wanita.y + display.contentHeight/10, display.contentWidth * 0.8, 50 )
...
function scene:show( event )
	...
	elseif phase == "did" then
     ...
     local function loadIconListenerPerlengkapanHaji( event )
          ...
          local index
             ...
             for index = 1, data_max do
                  ...
                  local data = listData[index]
                    ...
                    local count = composer.gambar_iklan_perlengkapanhaji
                    ...
                    local myImage = display.newImage( composer.imgDir.. "logo.png", 125, 39)
                      ...
                      local posisi_teks_x = myImage.x + (myImage.width * myImage.xScale /2)
                       ...
                       if(composer.gambar_iklan_perlengkapanhaji%2 == 1)then
					...
					myImage:addEventListener("tap", onProduk )
			         ...
			         scrollView:insert(teks_produk_diskon_harga);
                      ...
                      if(composer.gambar_iklan_perlengkapanhaji == data_max) then
	...
	if(composer.halaman_menu4 == 1)then
		tampil_prev.alpha = 0
	...
	local function ontampil_next(event) 
	   ...
	   function but_tampil_prev(self) 
	            ...
	            composer.halaman_page = composer.halaman_page - 10
                    ...
                    cancelall[index] = network.download( download, "GET", networkListener,params, "perlengkapanhaji"..index..".jpg", system.TemporaryDirectory, 0, 0 )
	...
	if(composer.status_kategori == 1)then
			dl_id1 =network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/61/-/terbaru/-/10/"..composer.halaman_page, "GET", dataResponseListenerPerlengkapanHaji )    		
	elseif(composer.status_kategori == 2)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/61/terendah/terbaru/-/10/"..composer.halaman_page, "GET", dataResponseListenerPerlengkapanHaji ) 
	elseif(composer.status_kategori == 3)then
    		dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/filter/61/-/-/terlaris/10/"..composer.halaman_page, "GET", dataResponseListenerPerlengkapanHaji) 
	elseif(composer.status_kategori == 4)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/perlengkapan-haji-pria/10/"..composer.halaman_page, "GET", dataResponseListenerPerlengkapanHaji)
	elseif(composer.status_kategori == 5)then
			dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkcategory/perlengkapan-haji-wanita/10/"..composer.halaman_page, "GET", dataResponseListenerPerlengkapanHaji)
	end
