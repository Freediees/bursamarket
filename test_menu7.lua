...
function scene:create( event )
  ...
  composer.tinggi_teksfield = background2.height + display.contentHeight/30
	...
	local teks_sajadah = display.newText( "Produk Diskon", display.contentCenterX, display.contentHeight/20 , used_font_bold, 15  * (display.contentWidth / 320))
	...
	composer.posisi_y = teks_sajadah.y + display.contentHeight/20
