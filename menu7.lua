...
function scene:show( event )
    ...
    composer.removeHidden()
             ...
             for index = 1, data_max do
                  ...
                  local data = listData[index]
                    ...
                    composer.image = data.image
                   	...
                   	--table.insert(nama_produk,index, data.product) 

                   	--print(table.concat(nama_produk))

                   	--print("data produk : "..data.product)
                   	--print("data pada table : "..table.concat(composer.nama_produk))

                    --print("Nama link : "..composer.url_link)
                    --print("Nama Gambar : "..composer.image)


                    local function loadIconListener( event )
      ...
      elseif ( event.phase == "ended" ) then
	      ...
	      myImage.anchorY = 0
	      if(composer.gambar_iklan%2 == 1)then
	      		myImage.x = composer.posisi_x1
	      		myImage.anchorX = 1
	      else
	      		myImage.x = composer.posisi_x2
	      		myImage.anchorX = 0
	      end
	      ...
	      scrollView:insert(myImage)
			...
			if fhd then
              ...
              local teks  = data.product --table.concat(composer.table1, ", ", composer.gambar_iklan,composer.gambar_iklan)
              local teks2 = data.regular_price --table.concat(composer.data_harga, ", ", composer.gambar_iklan,composer.gambar_iklan)
              local teks3 = data.disc_price --table.concat(composer.data_harga_disc, ", ", composer.gambar_iklan,composer.gambar_iklan)
			...
			myImage:addEventListener("tap", onProduk )
                     ...
                     x = posisi_teks_x - myImage.width * myImage.xScale + display.contentWidth/10,
					...
					scrollView:insert(coret)
                     ...
                     text = tostring("Rp. "..teks3..",-"),
                     x = posisi_teks_x + myImage.width * myImage.xScale + display.contentWidth/20, 
                     y = teks_produk_diskon.y + teks_produk_diskon.height + display.contentHeight/40,
                     font = used_font_bold,
                     fontSize = 9  * (display.contentWidth / 320),
                     align = "left",
			         ...
			         local teks_produk_diskon_harga_diskon = display.newText(options3)
			         teks_produk_diskon_harga_diskon.anchorX = 1
			         teks_produk_diskon_harga_diskon.anchorY = 0
			         teks_produk_diskon_harga_diskon:setFillColor(0,0,0);
			         scrollView:insert(teks_produk_diskon_harga_diskon);
                      ...
                      if(composer.gambar_iklan == data_max)then
          			...
          			local tampil_next = display.newText( "Next", 0 + display.contentWidth * 0.8, composer.tinggi_scrollview + 150 , used_font_bold, 15  * (display.contentWidth / 320))
					...
					if composer.data_max < 10 then
						tampil_next.alpha = 0
						myRoundedRect.alpha = 0
					else
					...
					local tampil_prev = display.newText( "Prev", 0 + display.contentWidth * 0.8 - tampil_next.width, composer.tinggi_scrollview + 150 , used_font_bold, 15  * (display.contentWidth / 320))
					...
					if(composer.halaman_menu7 == 1)then
						tampil_prev.alpha = 0
	...
	--================================================================================================================================
				   ...
				   function but_tampil_next(self) 
				            ...
				            composer.gotoScene( "menu7" ) 
				            composer.halaman_menu7 = composer.halaman_menu7 + 10
				   ...
				   function but_tampil_prev(self) 
                    ...
                    cancelall[index] = network.download( download, "GET", loadIconListener,params, "iklan"..index..".jpg", system.TemporaryDirectory, 0, 0 )
    ...
    local function dataResponseListener3( event )
          ...
          if ( event.isError ) then
            ...
            for index = 1, data_max do
            	...
            	table.insert(composer.data_harga_disc, index, data.disc_price)
            end
	...
	dl_id1 = network.request( "http://api.bursasajadah.com/api/bursasajadah/produkdiskon/10/"..composer.halaman_menu7, "GET", dataResponseListener3 )
