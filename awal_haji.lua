...
function scene:create( event )
        ...
        for row in db:nrows("SELECT * FROM t_video") do
            if(row.video1 == '0')then
                ...
                download = network.download(
                    --"http://bursasajadah.com/video/intro.mp4",
	...
	local options = {
		 text = [[Ibadah Haji merupakan salah satu ibadah wajib yang dijalankan oleh umat islam, dengan cara
berkunjung ke tanah suci atau ka’bah baitullah untuk melakukan amal ibadah tertentu sesuai
dengan syarat, rukun, dan waktu yang telah ditentukan.
Hukum ibadah haji adalah wajib, terutama bagi mereka yang mampu. Berikut adalah firman Allah
SWT yang menjelaskan tentang hukum haji:]],
     ...
     local options = {
		 text = "وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا وَمَنْ كَفَرَ فَإِنَّ اللَّهَ غَنِيٌّ عَنِ الْعَالَمِينَ",
         x = display.contentWidth*0.05,
   ...
   --   local options = {
		 -- text = [[walillahi 'alannaasi hijjul baiti maniistathaa'a ilaihi sabiilaa]],
   --       x = display.contentWidth*0.05,
