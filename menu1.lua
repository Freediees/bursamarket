...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
	...
	local teks_tipe = display.newText( "TIPE", display.contentCenterX - display.contentWidth / 5, display.contentHeight/20 , used_font_bold, 17  * (display.contentWidth / 320))
	teks_tipe.anchorX = 0.5
	teks_tipe:setFillColor(133/255,190/255,72/255)
   ...
   function but_teks_tipe(self) 
	...
	local teks_ukuran = display.newText( "UKURAN", display.contentCenterX + display.contentWidth / 5, display.contentHeight/20 , used_font_bold, 17  * (display.contentWidth / 320))
	teks_ukuran.anchorX = 0.5
	teks_ukuran:setFillColor(133/255,190/255,72/255)
   ...
   function but_teks_ukuran(self) 
	...
	local terbaru_box = display.newRect( display.contentCenterX, teks_tipe.y + display.contentHeight/10, display.contentWidth * 0.8, 50 )
