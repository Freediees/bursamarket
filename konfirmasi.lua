...
function scene:create( event )
 ...
 --    title:addEventListener("tap", onSecondView ) 
    ...
    local background_konfirmasi = display.newRect( display.contentCenterX, garis6.y + display.contentHeight/20, 0.9 * display.contentWidth, 50)
