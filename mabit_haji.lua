...
function scene:create( event )
            ...
            if(row.video9 == '0')then
                ...
                local function networkListener( event )
                    ...
                    elseif ( event.phase == "progress" ) then
                        if ( event.bytesEstimated <= 0 ) then
                            transfered.text = event.bytesTransferred.."/6178581"
                    ...
                    elseif ( event.phase == "ended" ) then
                        ...
                        transfered.text = event.bytesEstimated.."/6178581"


                         local tablesetup = [[UPDATE t_video set video9 = '1';]]
                         db:exec( tablesetup )
                        ...
                        video.anchorY = 0
                        video:load( "video9.mp4", system.DocumentsDirectory )
                        video:play()
                        ...
                        local function on_video()
                            ...
                            media.playVideo( "video9.mp4", system.DocumentsDirectory, true )
                        end
                ...
                download = network.download(
                    "http://bursasajadah.com/video/pelaksanaan_ibadah_haji-mabit_di_muzdalifah.mp4",
                    "GET",
                    networkListener,
                    params,
                    "video9.mp4",
	...
	local teks_judul = display.newText("Mabit di Muzdalifah",display.contentWidth*0.05 , 0 + display.contentHeight/20, "Roboto.ttf", 20  * (display.contentWidth / 320)  )
	...
	local options = {
		 text = [[1.	Selama di Muzdalifah dianjurkan untuk memperbanyak bacaan talbiyah, zikir, doa dan membaca Al-Quran

2.	Bagi jamaah yang tiba di Muzdalifah sebelum tengah malam, harus menunggu sampai lewat tengah malam.

3.	Mencari dan mengambil kerikil untuk jumrah
