...
composer.used_font = "Raleway-Bold.ttf"
...
function scene:create( event )
	...
	for row in db:nrows("SELECT * FROM t_status") do
		composer.status_member = row.status_member
	end
	...
	background2:setFillColor( 205/255,176/255,48/255)

	local under = display.newRect( 0, background2.y + background2.height, display.contentWidth/2, 5)
	under.anchorY = 1
	under.anchorX = 0
	...
	local teks_daftar_isi = display.newText( "Daftar Isi", menu.x + display.contentWidth/8 , menu.y , "Roboto.ttf", 20  * (display.contentWidth / 320)  )
	teks_daftar_isi.anchorX = 0
	teks_daftar_isi.anchorY = 0.5
	teks_daftar_isi.alpha = 1

	local teks_umroh = display.newText( "Umroh", menu.x + display.contentWidth/8 , menu.y , "Roboto.ttf", 15  * (display.contentWidth / 320)  )
	...
	local teks_haji = display.newText( "Haji", menu.x + display.contentWidth/8 , menu.y , "Roboto.ttf", 15  * (display.contentWidth / 320)  )
    ...
    teks_haji:addEventListener("tap", onteks_haji) 
	...
	local option1 = display.newText( "Video Panduan Ibadah Umroh Full", display.contentWidth/15 , tinggi_option , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	option1.anchorX = 0
	option1.anchorY = 0
	...
	function on_option1(self) 
            if nil~= composer.getScene("awal_umroh") then composer.removeScene("awal_umroh", true) end  
            if  self.type == "press" then 
                self:setEnabled(false) 
            else 
                
            end    
            composer.gotoScene( "awal_umroh" ) 
    end
    option1_back:addEventListener("tap", on_option1)

	
	local option2 = display.newText( "Ihram", display.contentWidth/15 , option1.y + option1.height + display.contentHeight/35 , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	option2.anchorX = 0
	option2.anchorY = 0
	...
	function on_option2(self) 
		        ...
		        if nil~= composer.getScene("ihram_umroh") then composer.removeScene("ihram_umroh", true) end  
		        if  self.type == "press" then 
		            self:setEnabled(false) 
		        else 
		            
		        end    
		        composer.gotoScene( "ihram_umroh" ) 
       		
    end
    option2_back:addEventListener("tap", on_option2)


	local option3 = display.newText( "Thawaf", display.contentWidth/15 , option2.y + option2.height + display.contentHeight/35 , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	option3.anchorX = 0
	option3.anchorY = 0
	...
	local doa1_thawaf = display.newText( "Doa Thawaf 1", display.contentWidth/15 , option3.y + option3.height + display.contentHeight/35 , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	...
	local option4 = display.newText( "Sa'i", display.contentWidth/15 , thawaf_lanjutan.y + thawaf_lanjutan.height + display.contentHeight/35 , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	option4.anchorX = 0
	option4.anchorY = 0
	...
	local option5 = display.newText( "Tahallul", display.contentWidth/15 , option4.y + option4.height + display.contentHeight/35 , "Roboto.ttf", 13  * (display.contentWidth / 320)  )
	option5.anchorX = 0
	option5.anchorY = 0
	...
	-- local option6 = display.newText( "Tahallul", display.contentWidth/15 , option5.y + option5.height + display.contentHeight/25 , "Roboto.ttf", 15  * (display.contentWidth / 320)  )
	-- option6.anchorX = 0
	-- option6.anchorY = 0
	...
	-- local option7 = display.newText( "Oleh-Oleh dan Souvenir Umroh", display.contentWidth/15 , option6.y + option6.height + display.contentHeight/25 , "Roboto.ttf", 15  * (display.contentWidth / 320)  )
	-- option7.anchorX = 0
	-- option7.anchorY = 0
